...
--
-- Table structure for table `daysinmonth`
--
...
CREATE TABLE `daysinmonth` (
  `daysinmonthid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  `numdays` int(10) unsigned NOT NULL,
  PRIMARY KEY (`daysinmonthid`)
...
LOCK TABLES `daysinmonth` WRITE;
/*!40000 ALTER TABLE `daysinmonth` DISABLE KEYS */;
INSERT INTO `daysinmonth` VALUES (1,'January',31),(2,'February',28),(3,'March',31),(4,'April',30),(5,'May',31),(6,'June',30),(7,'July',31),(8,'August',31),(9,'September',30),(10,'October',31),(11,'November',30),(12,'December',31);
...
-- Dump completed on 2019-06-18 22:42:58
